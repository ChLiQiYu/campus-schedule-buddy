...
class CourseCardView @JvmOverloads constructor(
    ...
    init {
        ...
        val alertParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT)
        alertParams.topMargin = dpToPx(2)
        taskAlertTextView.layoutParams = alertParams
        // 添加触摸监听器实现按压效果
